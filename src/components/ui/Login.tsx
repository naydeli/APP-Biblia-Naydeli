...
import { FaGoogle, FaGithub,FaBible } from "react-icons/fa";
  ...
  return (
    <div className="flex items-center justify-center h-screen w-screen bg-green-100">
      <div className="bg-white shadow-2xl rounded-3xl p-14 w-[600px]  shadow-green-500 text-center border border-green-300">
        ...
        <div className="flex flex-col gap-5 ">
          <button
            ...
            className="flex items-center justify-center w-full bg-green-500  shadow-green-200 hover:bg-green-600 text-white font-semibold py-4 rounded-2xl transition-all duration-300 shadow-lg text-xl"
          >
          ...
          <button
            ...
            className="flex items-center justify-center w-full bg-gray-800  shadow-green-500 hover:bg-gray-900 text-white font-semibold py-4 rounded-2xl transition-all duration-300 shadow-lg text-xl"
          >
